 ...
 *
 * libpulse-simple shim → AAudio  (original mechanism by udarmolota for ValDroid).
 * Copyright (c) 2026 udarmolota
 *
 * This single file is MIT-licensed (NOT the GPL-3.0 of the rest of ValDroid), so it can be reused
