...
public class GameActivity extends Activity implements SurfaceHolder.Callback {
    ...
    private static com.valdroid.xserver.Pointer.Button xBtn(int button) {
        switch (button) {
            ...
            case 3:  return com.valdroid.xserver.Pointer.Button.BUTTON_RIGHT;
            default: return com.valdroid.xserver.Pointer.Button.BUTTON_LEFT;
        }
    }
    ...
    private static com.valdroid.xserver.XKeycode xKey(int sdlScancode) {
        switch (sdlScancode) {
            ...
            case 33: return com.valdroid.xserver.XKeycode.KEY_4;
            case 34: return com.valdroid.xserver.XKeycode.KEY_5;
            case 35: return com.valdroid.xserver.XKeycode.KEY_6;
            case 36: return com.valdroid.xserver.XKeycode.KEY_7;
            case 37: return com.valdroid.xserver.XKeycode.KEY_8;
            case 38: return com.valdroid.xserver.XKeycode.KEY_9;
            case 39: return com.valdroid.xserver.XKeycode.KEY_0;
            // arrows — the on-screen pan stick emits these scancodes (camera panning)
            case 79: return com.valdroid.xserver.XKeycode.KEY_RIGHT;
            case 80: return com.valdroid.xserver.XKeycode.KEY_LEFT;
            case 81: return com.valdroid.xserver.XKeycode.KEY_DOWN;
            case 82: return com.valdroid.xserver.XKeycode.KEY_UP;
            // function row (RimWorld: F1 help etc.; SDL scancodes 58..69 = F1..F12)
            case 58: return com.valdroid.xserver.XKeycode.KEY_F1;
            case 59: return com.valdroid.xserver.XKeycode.KEY_F2;
            case 60: return com.valdroid.xserver.XKeycode.KEY_F3;
            case 61: return com.valdroid.xserver.XKeycode.KEY_F4;
            case 62: return com.valdroid.xserver.XKeycode.KEY_F5;
            case 63: return com.valdroid.xserver.XKeycode.KEY_F6;
            case 64: return com.valdroid.xserver.XKeycode.KEY_F7;
            case 65: return com.valdroid.xserver.XKeycode.KEY_F8;
            case 66: return com.valdroid.xserver.XKeycode.KEY_F9;
            case 67: return com.valdroid.xserver.XKeycode.KEY_F10;
    ...
    public static void scrollInput(int x, int y, int dy) {
        ...
        com.valdroid.xserver.Pointer.Button b = dy > 0
                ...
                : com.valdroid.xserver.Pointer.Button.BUTTON_SCROLL_DOWN;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //   am start -n com.valdroid/.GameActivity --es instance_name X --ez autolaunch true
        if (getIntent().getBooleanExtra("autolaunch", false) && instanceName != null) {
            final com.valdroid.game.GameInstance gi =
                    com.valdroid.game.GameInstanceManager.requireSingleton().getByName(instanceName);
            if (gi != null) {
                new Thread(() -> {
                    try {
        ...
        if (fixedRes != com.valdroid.InstanceSettings.FIXED_NONE) {
            ...
            boolean wide = (fixedRes == com.valdroid.InstanceSettings.FIXED_720_16_9);
            ...
            com.valdroid.GameLauncher.lastFixedGeom = geom;
        } else {
    ...
    private static final com.valdroid.input.Binding[] PAN_KEYS = {
        com.valdroid.input.Binding.KEY_UP, com.valdroid.input.Binding.KEY_RIGHT,
        com.valdroid.input.Binding.KEY_DOWN, com.valdroid.input.Binding.KEY_LEFT };
    ...
    private boolean isGamepadConnected() {
        return com.valdroid.input.GamepadHandler.hasConnectedGamepad();
    }
    ...
    private void pinGamePrefs(int width, int height) {
        try {
            ...
            com.valdroid.game.GameInstanceManager mgr =
                    com.valdroid.game.GameInstanceManager.requireSingleton();
            mgr.reload();
            com.valdroid.game.GameInstance gi = mgr.getByName(name);
            if (gi == null) return;
