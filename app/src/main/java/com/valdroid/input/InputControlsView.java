...
public class InputControlsView extends View {
    ...
    public InputControlsView(Context c, float renderScale, String instanceName) {
        ...
        if (instanceName != null) {
            hapticEnabled = new com.valdroid.InstanceSettings(instanceName).isHapticFeedback();
        } else {
    ...
    public void loadFromPrefsOrDefault() {
        String json = null;
        if (instanceName != null) {
            json = new com.valdroid.InstanceSettings(instanceName).getControlsJson();
        } else {
            LauncherPreferences lp = LauncherPreferences.getSingleton();
    ...
    public void saveToPrefs() {
        if (instanceName != null) {
            new com.valdroid.InstanceSettings(instanceName).setControlsJson(toJson());
        } else {
            LauncherPreferences lp = LauncherPreferences.getSingleton();
