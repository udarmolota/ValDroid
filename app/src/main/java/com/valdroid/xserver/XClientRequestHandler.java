...
import com.valdroid.xconnector.ConnectedClient;
import com.valdroid.xconnector.RequestHandler;
...
import com.valdroid.xserver.extensions.Extension;
import com.valdroid.xserver.requests.AtomRequests;
import com.valdroid.xserver.requests.CursorRequests;
import com.valdroid.xserver.requests.DrawRequests;
import com.valdroid.xserver.requests.ExtensionRequests;
import com.valdroid.xserver.requests.FontRequests;
import com.valdroid.xserver.requests.GrabRequests;
import com.valdroid.xserver.requests.GraphicsContextRequests;
import com.valdroid.xserver.requests.KeyboardRequests;
import com.valdroid.xserver.requests.PixmapRequests;
import com.valdroid.xserver.requests.SelectionRequests;
import com.valdroid.xserver.requests.WindowRequests;
            ...
            if (opcode < 0) {
                ...
                switch (opcode) {
                    ...
                    case 31:   // GrabKeyboard — pretend success (SDL grabs on fullscreen)
                        client.skipRequest();
                        try (com.valdroid.xconnector.XStreamLock lock = outputStream.lock()) {
                    ...
                    default:
                        ...
                        client.skipRequest();
                        new com.valdroid.xserver.errors.XRequestError(17, 0).sendError(client, opcode);
                        break;
                }
            }
        }
