...
public class FmodDecodeService extends Service {
    ...
    private void notifyDone(boolean ok) {
        try {
            ...
            String text = getString(ok ? com.valdroid.R.string.sound_done : com.valdroid.R.string.sound_failed);
            ...
            android.app.Notification n = new android.app.Notification.Builder(this, ch)
                    ...
                    .setContentTitle(getString(com.valdroid.R.string.app_name))
                    .setContentText(text)
