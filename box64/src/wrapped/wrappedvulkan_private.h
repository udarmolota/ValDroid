...
GOM(vkCmdBlitImage, vFEppupuupu)
GO(vkCmdClearAttachments, vFpupup)
GOM(vkCmdClearColorImage, vFEppupup)
GO(vkCmdClearDepthStencilImage, vFppupup)
GO(vkCmdCopyBuffer, vFpppup)
GOM(vkCmdCopyBufferToImage, vFEpppuup)
GOM(vkCmdCopyImage, vFEppupuup)
GOM(vkCmdCopyImageToBuffer, vFEppupup)
...
GOM(vkEnumerateDeviceExtensionProperties, iFEpppp)
GO(vkEnumerateDeviceLayerProperties, iFppp)
GOM(vkEnumerateInstanceExtensionProperties, iFEppp)
...
GOM(vkGetPhysicalDeviceMemoryProperties2, vFEpp)
...
GOM(vkCmdBlitImage2, vFEpp)
GO(vkCmdCopyBuffer2, vFpp)
GOM(vkCmdCopyBufferToImage2, vFEpp)
GOM(vkCmdCopyImage2, vFEpp)
...
GOM(vkCmdPipelineBarrier2, vFEpp)
...
GOM(vkGetPhysicalDeviceMemoryProperties2KHR, vFEpp)
...
GOM(vkGetPhysicalDeviceSurfaceCapabilitiesKHR, iFEppp)
GOM(vkGetPhysicalDeviceSurfaceFormatsKHR, iFEpppp)
GO(vkGetPhysicalDeviceSurfacePresentModesKHR, iFpppp)
GOM(vkGetPhysicalDeviceSurfaceSupportKHR, uFEpupp)

// VK_KHR_xcb_surface
GOM(vkCreateXcbSurfaceKHR, iFEpppp)
GOM(vkGetPhysicalDeviceXcbPresentationSupportKHR, uFEpupp)

// VK_KHR_xlib_surface
GOM(vkCreateXlibSurfaceKHR, iFEpppp)
GOM(vkGetPhysicalDeviceXlibPresentationSupportKHR, uFEpupp)

// VK_KHR_android_surface
GOM(vkCreateAndroidSurfaceKHR, iFEpppp)

// VK_KHR_swapchain
GOM(vkAcquireNextImageKHR, iFEppUppp)
...
GOM(vkCmdBlitImage2KHR, vFEpp)
GO(vkCmdCopyBuffer2KHR, vFpp)
GOM(vkCmdCopyBufferToImage2KHR, vFEpp)
GOM(vkCmdCopyImage2KHR, vFEpp)
...
GOM(vkCmdPipelineBarrier2KHR, vFEpp)
