...
void pFpuipi(x64emu_t *emu, uintptr_t fnc);
...
void pFppLLL(x64emu_t *emu, uintptr_t fnc);
...
void pFEppipi(x64emu_t *emu, uintptr_t fnc);
...
void pFpuipip(x64emu_t *emu, uintptr_t fnc);
...
void vFEppupup(x64emu_t *emu, uintptr_t fnc);
void vFEpppuup(x64emu_t *emu, uintptr_t fnc);
...
void vFEppupuup(x64emu_t *emu, uintptr_t fnc);
...
void vFEppupuupu(x64emu_t *emu, uintptr_t fnc);
